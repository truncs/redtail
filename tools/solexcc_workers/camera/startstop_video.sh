...
startvideo_depth() {
rosrun image_view video_recorder image:=/zed/zed_node/confidence/confidence_image _filename:=/home/apsync/dflogger/dataflash/zed_video/zed_con_map_vid`ls /home/apsync/dflogger/dataflash/zed_video/zed_con_map_vid* | wc -l`.avi _codec:="I420" > /dev/null &
        }
