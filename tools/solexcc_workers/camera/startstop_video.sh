...
startvideo_depth() {
rosrun image_view video_recorder image:=/stereo_dnn_ros_viz/output/ _filename:=/home/apsync/dflogger/dataflash/zed_video/zed_depth_video`ls /home/apsync/dflogger/dataflash/zed_video/zed_depth_video* | wc -l`.avi _codec:="I420" > /dev/null & 
	}
