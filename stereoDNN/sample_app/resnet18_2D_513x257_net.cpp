                                     ...
                                     ILogger& log)
{
    ...
    auto conv2D_1 = network->addConvolutionNd(*concat->getOutput(0), 32, DimsHW {3, 3},
                                       weights.at("conv2D_1_k"), weights.at("conv2D_1_b"));
    assert(conv2D_1 != nullptr);
    conv2D_1->setName("conv2D_1");
    conv2D_1->setStrideNd( DimsHW {1, 1});
    conv2D_1->setPaddingNd(DimsHW {1, 1});
    ...
    auto conv2D_2 = network->addConvolutionNd(*conv2D_1_act->getOutput(0), 32, DimsHW {3, 3},
                                       weights.at("conv2D_2_k"), weights.at("conv2D_2_b"));
    assert(conv2D_2 != nullptr);
    conv2D_2->setName("conv2D_2");
    conv2D_2->setStrideNd( DimsHW {1, 1});
    conv2D_2->setPaddingNd(DimsHW {1, 1});
    ...
    auto conv2D_3ds = network->addConvolutionNd(*conv2D_2_act->getOutput(0), 64, DimsHW {3, 3},
                                       weights.at("conv2D_3ds_k"), weights.at("conv2D_3ds_b"));
    assert(conv2D_3ds != nullptr);
    conv2D_3ds->setName("conv2D_3ds");
    conv2D_3ds->setStrideNd( DimsHW {2, 2});
    conv2D_3ds->setPaddingNd(DimsHW {1, 1});
    ...
    auto conv2D_4 = network->addConvolutionNd(*conv2D_3ds_act->getOutput(0), 64, DimsHW {3, 3},
                                       weights.at("conv2D_4_k"), weights.at("conv2D_4_b"));
    assert(conv2D_4 != nullptr);
    conv2D_4->setName("conv2D_4");
    conv2D_4->setStrideNd( DimsHW {1, 1});
    conv2D_4->setPaddingNd(DimsHW {1, 1});
    ...
    auto conv2D_5 = network->addConvolutionNd(*conv2D_4_act->getOutput(0), 64, DimsHW {3, 3},
                                       weights.at("conv2D_5_k"), weights.at("conv2D_5_b"));
    assert(conv2D_5 != nullptr);
    conv2D_5->setName("conv2D_5");
    conv2D_5->setStrideNd( DimsHW {1, 1});
    conv2D_5->setPaddingNd(DimsHW {1, 1});
    ...
    auto conv2D_6ds = network->addConvolutionNd(*conv2D_5_act->getOutput(0), 128, DimsHW {3, 3},
                                       weights.at("conv2D_6ds_k"), weights.at("conv2D_6ds_b"));
    assert(conv2D_6ds != nullptr);
    conv2D_6ds->setName("conv2D_6ds");
    conv2D_6ds->setStrideNd(DimsHW {2, 2});
    conv2D_6ds->setPaddingNd(DimsHW {1, 1});
    ...
    auto conv2D_7 = network->addConvolutionNd(*conv2D_6ds_act->getOutput(0), 128, DimsHW {3, 3},
                                       weights.at("conv2D_7_k"), weights.at("conv2D_7_b"));
    assert(conv2D_7 != nullptr);
    conv2D_7->setName("conv2D_7");
    conv2D_7->setStrideNd(DimsHW {1, 1});
    conv2D_7->setPaddingNd(DimsHW {1, 1});
    ...
    auto conv2D_8 = network->addConvolutionNd(*conv2D_7_act->getOutput(0), 128, DimsHW {3, 3},
                                       weights.at("conv2D_8_k"), weights.at("conv2D_8_b"));
    assert(conv2D_8 != nullptr);
    conv2D_8->setName("conv2D_8");
    conv2D_8->setStrideNd(DimsHW {1, 1});
    conv2D_8->setPaddingNd(DimsHW {1, 1});
    ...
    deconv2D_1->setStrideNd(DimsHW {2, 2});
    deconv2D_1->setPaddingNd(DimsHW {1, 1});
    ...
    deconv2D_2->setStrideNd(DimsHW {2, 2});
    deconv2D_2->setPaddingNd(DimsHW {1, 1});
    ...
    deconv2D_3->setStrideNd(DimsHW {2, 2});
    deconv2D_3->setPaddingNd(DimsHW {1, 1});
